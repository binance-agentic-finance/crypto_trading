...
STAGES = (
    {"n": 0, "name": "sample", "input": "raw bars per symbol",
     "output": "dict[symbol, DataFrame] on one grid", "impl": "factor_eval.bars.sample_bars"},
    {"n": 1, "name": "panel", "input": "bars + extras + eligibility",
     "output": "Panel (aligned cells x symbols)", "impl": "factor_eval.bars.build_panel"},
    {"n": 2, "name": "factors", "input": "Panel",
     "output": "dict[name, DataFrame]", "impl": "factor_eval.capability_registry / library"},
    {"n": 3, "name": "preprocess", "input": "dict[name, DataFrame]",
     "output": "dict[name, DataFrame]", "impl": "factor_eval.preprocess"},
    {"n": 4, "name": "forecast", "input": "factors + Panel",
     "output": "DataFrame (expected return score)", "impl": "factor_eval.forecast"},
    {"n": 5, "name": "sizing", "input": "mu + mask",
     "output": "DataFrame (target weights)", "impl": "factor_eval.forecast.positions_from_forecast"},
    {"n": 6, "name": "backtest", "input": "W + Panel",
     "output": "BacktestResult", "impl": "factor_eval.framework.backtest_weights"},
    {"n": 7, "name": "compare", "input": "BacktestResult + benchmarks",
     "output": "DataFrame per split", "impl": "factor_eval.benchmarks.compare"},
)
