...
(oi_funding_breakout)生成;信号与仓库内置策略逐根一致(tests/standard_bot/test_square_submit.py)。不要手改。
"""
import asyncio
import time
...
from binance.strategy.node.capabilities.data import klines, derivatives_market_metrics, futures_position_risk
