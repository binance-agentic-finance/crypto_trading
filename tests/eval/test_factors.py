...
MODULE = Path(__file__).resolve().parents[2] / "eval/alpha101_crypto/factors.py"
spec = importlib.util.spec_from_file_location("alpha101_v2_factors_test_target", MODULE)
