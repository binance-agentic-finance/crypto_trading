...
from cyqnt_trd.eval.blueprint import Blueprint, Exits, Tier                     # noqa: E402
from cyqnt_trd.eval.optimize import (Ledger, build_ledger, deflated_sharpe,     # noqa: E402
...
def test_a_single_point_ensemble_is_that_blueprint(panel):
    ...
    from cyqnt_trd.eval.blueprint import blueprint_targets
    close = panel.close
